...
#region 21653406-6211-4F18-B661-A360B581B397
            ...
            modelBuilder.Entity<MethodDetail>().HasData(
                 ...
                 new MethodDetail
                 {
                     MethodId = Guid.Parse("05AB75D8-622B-4BAB-9543-AD10E441D7D6"),
                     SkinId = Guid.Parse("05AB75D8-622B-4BAB-9543-AD10E441D7D6"),// Da khô
                 },
                 new MethodDetail
                 {
                     MethodId = Guid.Parse("90A11B66-E89F-45AB-BFC4-B31101D0DD81"),
                     SkinId = Guid.Parse("90A11B66-E89F-45AB-BFC4-B31101D0DD81"),// Da dầu
                 },
                 new MethodDetail
                 {
                     MethodId = Guid.Parse("BE37023D-6A58-4B4B-92E5-39DCECE45473"),
                     SkinId = Guid.Parse("BE37023D-6A58-4B4B-92E5-39DCECE45473"),// Da hỗn hợp
                 },
                 new MethodDetail
                 {
                     MethodId = Guid.Parse("A960D28F-2807-4D58-8248-91EEC518D415"),
                     SkinId = Guid.Parse("A960D28F-2807-4D58-8248-91EEC518D415"),// Da dầu
                 }
                 );
            #endregion
        }
