    ...
    public class CreateProductViewModelValidator : AbstractValidator<CreateProductViewModel>
    {
        ...
        public CreateProductViewModelValidator()
        {
            ...
            RuleFor(x => x.ClickMoney)
                .GreaterThan(1).WithMessage("Click money must be greater than 1.").LessThan(10000).WithMessage("Price must be less than 10000.");
            ...
            RuleFor(x => x.Price)
                .NotEmpty().WithMessage("Price is required.").GreaterThan(1).WithMessage("Price must be greater than 1.");
            RuleFor(x => x.URL)
