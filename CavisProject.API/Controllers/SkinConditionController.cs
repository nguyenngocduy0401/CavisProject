...
namespace CavisProject.API.Controllers
{
    ...
    public class SkinConditionController: ControllerBase
    {
        ...
        [SwaggerOperation(Summary = "tìm thông tin triệu chứng về da  {Authorize = Admin, Staff}")]
        [HttpGet("")]
        ...
        [SwaggerOperation(Summary = "tìm thông tin triệu chứng về da bằng id {Authorize = Admin, Staff}")]
        [HttpGet("{id}")]
